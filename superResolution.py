...
train_paths, test_paths = train_test_split(img_pths[:100], test_size=0.02, random_state=42)
...
if load_pretrained_models:
    generator.load_state_dict(torch.load("/workstation/bhanu/neuralPhotoEditing/SuperResolution/saved_models/generator.pth"))
    discriminator.load_state_dict(torch.load("/workstation/bhanu/neuralPhotoEditing/SuperResolution/saved_models/discriminator.pth"))
...
for epoch in range(n_epochs):
    ...
    for batch_idx, imgs in enumerate(tqdm_bar):
        ...
        if random.uniform(0,1)<0.8:
            ...
            save_image(img_grid, f"/workstation/bhanu/neuralPhotoEditing/SuperResolution/images/{batch_idx}.png", normalize=False)
    ...
    if np.argmin(test_gen_losses) == len(test_gen_losses)-1:
        torch.save(generator.state_dict(), "/workstation/bhanu/neuralPhotoEditing/SuperResolution/saved_models/generator.pth")
        torch.save(discriminator.state_dict(), "/workstation/bhanu/neuralPhotoEditing/SuperResolution/saved_models/discriminator.pth")
...
fig.show()
pio.write_image(fig, "Train_vs_Test_Generator_Loss.png")
...
fig.show()
pio.write_image(fig, "Train_vs_Test_Discriminator_Loss.png")